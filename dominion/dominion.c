...
int adventurerFunction(int currentPlayer, struct gameState *state, int *temphand, int cardDrawn, int z, int drawntreasure){
...
int gardensFunction(int currentPlayer, struct gameState *state){
  drawCard(currentPlayer, state);
  return 0;
}

int remodelFunction(int currentPlayer, int choice1, int choice2, struct gameState *state, int handPos){
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
       adventurerFunction(currentPlayer, state, &temphand, cardDrawn, z, drawntreasure);
       return 0;
  ...
  temphand[i] = -1;
    ...
    case gardens:
      gardensFunction(currentPlayer, state);
      return -1;
      ...
      for (i = 0; i < state->handCount[currentPlayer]; i++)
  {
    ...
    case remodel:
      ...
      return remodelFunction(currentPlayer, choice1, choice2, state, handPos); 
